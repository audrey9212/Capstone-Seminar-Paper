...
|---------------|------------------------------|--------------|
| Test ROC-AUC | 0.6679–0.6704 | 0.6637 |
| Test PR-AUC | 0.4490–0.4517 | 0.4454 |
...
This highlights that the "best" model on paper is not always the best in practice; **model selection must consider deployment constraints, maintainability, and interpretability requirements** as well as raw performance. In this case, XGBoost is the recommended production choice: it delivers strong test performance while maintaining operational simplicity.
