...
| Model | Optimal τ | Precision | Recall | F1 | ROC-AUC |
|-------|-----------|-----------|--------|----------|---------|
...
| | Logistic | XGBoost | LightGBM | RF |
|----------|----------|---------|----------|----|
| Logistic | 1.0000 | 0.4778 | 0.4685 | 0.4739 |
| XGBoost | 0.4778 | 1.0000 | 0.9313 | 0.8786 |
| LightGBM | 0.4685 | 0.9313 | 1.0000 | 0.8691 |
| RF | 0.4739 | 0.8786 | 0.8691 | 1.0000 |
...
|-------|--------------|----------------|--------------|
| Logistic | 0.1621 | 0.0651 | 0.2500 |
| XGBoost | 0.2886 | 0.5866 | 0.2500 |
| LightGBM | 0.2759 | 0.1751 | 0.2500 |
| RF | 0.2734 | 0.1731 | 0.2500 |
...
The OOF stacking meta-learner (logistic regression with L2 regularization) was trained on out-of-fold predictions from four base models: Logistic Regression, XGBoost, LightGBM, and Random Forest. XGBoost and LightGBM received the largest weights, consistent with their superior individual ranking performance.
...
| OOF Stacking (4 models) | 0.3000 | 0.3200 | 0.4670 |
| OOF Stacking + Wide & Deep | 0.2243 | 0.2189 | — |

: Optimal thresholds per model under different criteria. The five-model OOF stacking requires a lower threshold (≈0.22) because the meta-learner probability scale differs from raw model scores. {#tbl-optimal-thresholds}
