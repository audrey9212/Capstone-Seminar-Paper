...
|---------|-------------------|--------|-----------|
| MadeCallToRetentionTeam | 0.95 | **EXCLUDED** | Post-decision: Customer called retention team after deciding to churn |
| RetentionCalls | 0.92 | **EXCLUDED** | Post-decision: Retention outreach triggered by churn indicators |
| RetentionOffersAccepted | 0.90 | **EXCLUDED** | Post-decision: Offers made only to at-risk customers |
| CustomerCareCalls | 0.35 | Monitored | May include pre-churn complaints but also routine inquiries |
| PercChangeMinutes | 0.25 | Retained | Behavioral trend, not post-decision action |
| PercChangeRevenues | 0.25 | Retained | Behavioral trend, not post-decision action |
...
| | max_depth | [3, 6, 9] | 6 |
| | learning_rate | [0.01, 0.3] | 0.08 |
| | subsample | [0.6, 1.0] | 0.82 |
| | colsample_bytree | [0.6, 1.0] | 0.79 |
...
|-------|-------------|--------------|----------------|-------------|---------|-----------|
| Random Forest | 0.65 | 0.65 | 0.34 | 0.80 | 0.48 | 0.44 |
| XGBoost | 0.66 | 0.66 | 0.37 | 0.74 | 0.49 | 0.44 |
| LightGBM | 0.65 | 0.67 | 0.38 | 0.73 | 0.50 | 0.44 |
...
|----------------|------------------|-------------|
| learning_rate | 0.42 | Step size shrinkage |
| max_depth | 0.18 | Maximum tree depth |
| n_estimators | 0.14 | Number of boosting rounds |
| min_child_weight | 0.11 | Minimum sum of instance weight |
| subsample | 0.08 | Row sampling ratio |
| colsample_bytree | 0.07 | Column sampling ratio |
...
|------------|--------------|------|--------------|-------------|-------------|
| **wide_deep_focal** | **Wide & Deep** | **Focal (γ=2)** | **0.66** | **0.44** | **0.20** |
| embedding_focal_loss | Embedding MLP | Focal (γ=2) | 0.66 | 0.43 | 0.20 |
| dense_baseline | Dense MLP | Weighted BCE | 0.66 | 0.42 | 0.23 |
| wide_and_deep | Wide & Deep | Weighted BCE | 0.65 | 0.42 | 0.24 |
| embedding_baseline | Embedding MLP | Weighted BCE | 0.65 | 0.42 | 0.23 |
| wide_and_deep_deeper | Wide & Deep (Deeper) | Weighted BCE | 0.65 | 0.41 | 0.23 |
| embedding_strong_weight | Embedding MLP | Weighted BCE (×1.5) | 0.64 | 0.41 | 0.27 |
...
|----------|----------|---------|----------|----|----------|
| Logistic | 1.00 | 0.48 | 0.47 | 0.47 | 0.58 |
| XGBoost | 0.48 | 1.00 | 0.93 | 0.88 | 0.83 |
| LightGBM | 0.47 | 0.93 | 1.00 | 0.87 | 0.82 |
| RF | 0.47 | 0.88 | 0.87 | 1.00 | 0.80 |
| WideDeep | 0.58 | 0.83 | 0.82 | 0.80 | 1.00 |
...
|-------|--------------|----------------|--------------|
| Logistic | 0.09 | 0.00 | 0.20 |
| XGBoost | 0.16 | 0.25 | 0.20 |
| LightGBM | 0.15 | 0.05 | 0.20 |
| RandomForest | 0.15 | 0.02 | 0.20 |
| WideDeep | 0.15 | 0.68 | 0.20 |
...
|-----------------|-------------|--------------|-------------|
| Best Single (XGBoost) | 0.66 | 0.66 | 0.45 |
| Simple Average | 0.66 | 0.67 | 0.45 |
| AUC-Weighted | 0.66 | 0.67 | 0.45 |
| **NNLS-Optimized** | **0.66** | **0.67** | **0.45** |
| OOF Stacking (4 models) | 0.66 | 0.67 | 0.45 |
| **OOF Stacking + Wide & Deep** | **0.66** | **0.67** | **0.45** |
...
|------|------|------|------|------|-----------|--------|-------|-------------|
| 0.10 | 1471 | 3634 | 0 | 0 | 0.29 | 1.00 | 0.45 | 0.00 |
| 0.20 | 1468 | 3551 | 83 | 3 | 0.29 | 1.00 | 0.45 | 0.02 |
| 0.30 | 1368 | 3010 | 624 | 103 | 0.31 | 0.93 | 0.47 | 0.17 |
| 0.35 | 1309 | 2674 | 960 | 162 | 0.33 | 0.89 | 0.48 | 0.26 |
| 0.40 | 1221 | 2362 | 1272 | 250 | 0.34 | 0.83 | 0.48 | 0.35 |
| **0.44** | **1141** | **2087** | **1547** | **330** | **0.35** | **0.78** | **0.49** | **0.43** |
| 0.50 | 969 | 1567 | 2067 | 502 | 0.38 | 0.66 | 0.48 | 0.57 |
...
|-------|---------|---------|-------------|----------------|--------------|
| Logistic Regression | 0.44 | 0.46 | 0.84 | 0.31 | 0.59 |
| XGBoost | 0.44 | 0.49 | 0.74 | 0.37 | 0.66 |
| LightGBM | 0.44 | 0.50 | 0.73 | 0.38 | 0.67 |
| Random Forest | 0.44 | 0.48 | 0.80 | 0.34 | 0.65 |
| Wide&Deep (Focal) | 0.44 | 0.02 | 0.01 | 0.72 | 0.66 |
| OOF Stacking (4 models) | 0.44 | — | — | — | 0.67 |
| OOF Stacking + Wide & Deep | 0.22 | — | — | — | 0.67 |
