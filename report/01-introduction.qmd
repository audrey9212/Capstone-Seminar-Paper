...
- **Extension beyond supervised learning**: In addition to supervised modeling, a semi-supervised extension using a denoising autoencoder and pseudo-labeling is implemented and evaluated, addressing practical constraints in churn settings where labeling can be incomplete or delayed [@imanievaluatingclassificationsampling].
