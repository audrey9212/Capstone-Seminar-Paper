...
| OOF Stacking (4 models) | 0.2200 | — | — | — | 0.6679 |
| OOF Stacking + Wide & Deep | 0.2243 | — | — | — | 0.6702 |

: Model performance at the operational threshold. Individual models and blending variants use the fixed τ = 0.4400 selected by maximizing F1 subject to recall ≥ 0.70 on the validation set for XGBoost. OOF stacking variants use their own optimal thresholds (≈0.22) because the logistic meta-learner outputs probabilities on a compressed scale. Wide&Deep (Focal) exhibits near-zero recall at τ = 0.44 due to probability compression from focal loss, requiring threshold recalibration before deployment. {#tbl-optimal-thresholds}
