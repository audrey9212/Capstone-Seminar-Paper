...
Churn is a minority class but not extremely rare: 14,711 churners (28.82%) versus 36,336 non-churners (71.18%). A naïve classifier that always predicts "non-churn" would achieve 0.71 accuracy, demonstrating that accuracy alone is not a sufficient measure for this task.
